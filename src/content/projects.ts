...
export const projects: Project[] = [
  ...
  },
  {
    ...
    narrative: [
      '[placeholder] "Extrator" é um app desktop (Flask + React) que extrai dados de chicotes elétricos a partir de PDFs usando a API do Gemini, com histórico de cotações em um banco local.',
      '[placeholder] Sem mock interativo aqui — a demo é em vídeo, já que o app depende de PDFs e dados internos da HCP.',
    ],
    demoIndex: 0,
    demo: { type: 'video', src: '/videos/extrator-placeholder.mp4' },
  },
  {
    slug: 'itinerario',
    title: 'Itinerário',
