...
describe('EducationSection', () => {
  ...
  it('matches the section, role, company, and date typography from experience', () => {
    ...
    expect(screen.getByText(entry.degree)).toHaveClass('ui-text-entry-title', 'font-bold');
    expect(screen.getByText(entry.institution)).toHaveClass('ui-text-body', 'font-semibold');
    expect(screen.getByText(entry.period)).toHaveClass('font-mono', 'ui-text-meta');
  });
